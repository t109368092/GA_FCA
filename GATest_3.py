...
class GATest:
    ...
    def fitness_calculate(self, chromosomes):
        ...
        for i in range(chromosomes_count):
            ...
            print("ue_delay_lte", ue_delay_lte)
            print("ue_delay_nr", ue_delay_nr)
            print("ue_loss_lte", ue_loss_lte)
            print("ue_loss_nr", ue_loss_nr)
    ...
    def origin_fitness_calculate(self, chromosomes):
        chromosomes_count = len(chromosomes)
        nr_ratio = np.array(chromosomes)
